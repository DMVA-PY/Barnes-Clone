...
const HeroThird = () => {
  return (
    <div className="h-screen grid grid-cols-1 md:grid-cols-4 grid-rows-2 md:grid-rows-1 gap-4 p-4">
      {/* Big Text */}
      ...
      {/* Grid Items */}
      <div className=" mt-[-290px] sm:mt-[-260px] md:mt-[0px] col-span-1 md:col-span-3 grid md:grid-cols-3 lg:grid-cols-3 gap-4">
